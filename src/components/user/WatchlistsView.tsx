...
import { 
  ...
  MessageSquare, Factory, Zap, TrendingUp, TrendingDown, ArrowUpRight 
} from 'lucide-react';
                    ...
                    <div
                      ...
                      className={`flex items-center gap-1 px-2 py-1 rounded-md text-xs font-bold border transition-colors ${
                        isLight 
                          ...
                          : 'bg-[#0b0e14] border-blue-800 text-blue-400'
                      }`}
                    >
                      <button
                        onClick={() => onSelectStock(comp)}
                        className={`hover:opacity-80 transition-opacity`}
                        title={`View ${comp} in Platform`}
                      >
                        {comp}
                      </button>
                      <a
                        href={`https://finance.yahoo.com/quote/${comp}`}
                        target="_blank"
                        rel="noopener noreferrer"
                        className={`p-0.5 rounded-sm hover:bg-black/10 dark:hover:bg-white/10 transition-colors`}
